								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<?php echo $form->textField($model,'TGL_USUL',array('class'=>'form-control')); ?>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<?php echo $form->textField($model,'TG_KEPBSN',array('class'=>'form-control')); ?>
										</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<?php echo $form->textField($model,'RUANG1',array('class'=>'form-control')); ?>
												</div>
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-4 control-label">
														<?php echo $form->labelEx($model,'TGL_SAVE'); ?>
													</div>   

													<div class="col-sm-8">
														<?php echo $form->error($model,'TGL_SAVE'); ?>
														<?php echo $form->textField($model,'TGL_SAVE',array('class'=>'form-control')); ?>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<?php echo $form->textField($model,'TGL_UPDATE',array('class'=>'form-control')); ?>
													</div>
															...
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		<?php echo $form->textField($model,'statusws',array('class'=>'form-control')); ?>
																	</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		<?php echo $form->textField($model,'d_acuan',array('class'=>'form-control')); ?>
																	</div>
																									...
																									<div class="form-group">
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												...
																												<?php echo $form->textField($model,'kd_kat_standar_konsep',array('class'=>'form-control')); ?>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												...
																												<?php echo $form->textField($model,'strata_penggunaan_sni',array('class'=>'form-control')); ?>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												...
																												<?php echo $form->textField($model,'d_stdacuan',array('class'=>'form-control')); ?>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-4 control-label">
																												<?php echo $form->labelEx($model,'file_isi'); ?>
																											</div>   

																											<div class="col-sm-8">
																												<?php echo $form->error($model,'file_isi'); ?>
																												<?php echo $form->textField($model,'file_isi',array('class'=>'form-control')); ?>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												...
																												<?php echo $form->textField($model,'file_ringkasan',array('class'=>'form-control')); ?>
																											</div>
																										...
																										<div class="form-group">
																											...
																											<?php echo CHtml::ajaxSubmitButton ("Perbaharui",
																												array('ajax', 'id'=>$model->NO_ID),
																												array(
																													'update'=>'#req_res_loading',
																													'beforeSend' => 'function() {           
																														notie.alert({ type: \'info\', text: \'Proses...\', time: 10 , position: \'top\'});
																													}',
																													'complete' => 'function() {
																														notie.alert({ type: \'success\', text: \'Berhasil di Update\', time: 10 , position: \'top\'});
																														$("#req_res_loadings").hide();
																													}',        
																													),
																												array('class' => 'btn btn-info btn-flat pull-right')
																												); ?>
																											</div>
																										</div>
