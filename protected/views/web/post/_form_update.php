...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group row">
		<div class="col-sm-6">
			...
			<?php echo $form->textField($model,'url',array('class'=>'form-control','disabled'=>true)); ?>
		</div>
		<div class="col-sm-3">
			...
			<div class="form-group row">
				<div class="col-sm-6">
					...
					<?php echo $form->textArea($model,'tags',array('class'=>'form-control','placeHolder'=>'Keywords')); ?>
				</div>
