...
/**
 * This is the model class for table "mst_bidang".
 *
 * The followings are the available columns in table 'mst_bidang':
 * @property string $kd_bidang
 * @property string $nm_bidang
 */
class MstBidang extends CActiveRecord
{
	/**
