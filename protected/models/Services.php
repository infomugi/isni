...
class Services extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, icon, description, status, url', 'required'),
			...
			array('id_services, name, icon, description, status', 'safe', 'on'=>'search'),
			);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_services',$this->id_services);
	...
	public static function getServices(){
		$sql = "SELECT * FROM services WHERE status=1 LIMIT 4";
