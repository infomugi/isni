...
/**
 * This is the model class for table "tb_status_standar".
 *
 * The followings are the available columns in table 'tb_status_standar':
 * @property string $KD_KATEGORI
 * @property string $NM_KATEGORI1
 * @property string $NM_KATEGORI2
 */
class Statusstandar extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('KD_KATEGORI', 'unique'),
			array('KD_KATEGORI', 'length', 'max'=>5),
			array('NM_KATEGORI1, NM_KATEGORI2', 'length', 'max'=>75),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('KD_KATEGORI, NM_KATEGORI1, NM_KATEGORI2', 'safe', 'on'=>'search'),
			array('KD_KATEGORI, NM_KATEGORI1', 'required'),
			);
	}
	...
	public function attributeLabels()
	{
		return array(
			'KD_KATEGORI' => 'Kode',
			'NM_KATEGORI1' => 'Nama Status Standar',
			'NM_KATEGORI2' => 'Nm Kategori2',
			);
	}
	...
	public function search()
	{
		...
		$criteria->compare('KD_KATEGORI',$this->KD_KATEGORI,true);
		$criteria->compare('NM_KATEGORI1',$this->NM_KATEGORI1,true);
		$criteria->compare('NM_KATEGORI2',$this->NM_KATEGORI2,true);
	 ...
	 * @return StatusStandar the static model class
	 */
	...
	public static function getSni(){
		$sql = "SELECT * FROM tb_status_standar";
		$command = YII::app()->db->createCommand($sql);
		return $command->queryAll();
	}		

	public static function getReportSniDetail($sni){
		$sql = "SELECT
		nm_bidang AS bidang,
		no_nspm,
		judul1,
