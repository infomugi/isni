...
/**
 * This is the model class for table "tbjenis_standar".
 *
 * The followings are the available columns in table 'tbjenis_standar':
 * @property string $KD_JENIS_STANDAR
 * @property string $NM_JENIS_STANDAR1
 * @property string $NM_JENIS_STANDAR2
 */
class Jenisstandar extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('KD_JENIS_STANDAR', 'unique'),
			array('KD_JENIS_STANDAR', 'length', 'max'=>5),
			array('NM_JENIS_STANDAR1, NM_JENIS_STANDAR2', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('KD_JENIS_STANDAR, NM_JENIS_STANDAR1, NM_JENIS_STANDAR2', 'safe', 'on'=>'search'),
			array('KD_JENIS_STANDAR, NM_JENIS_STANDAR1', 'required'),
			);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'NM_JENIS_STANDAR1' => 'Jenis Standar',
			'NM_JENIS_STANDAR2' => 'Nm Jenis Standar2',
			);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NM_JENIS_STANDAR1',$this->NM_JENIS_STANDAR1,true);
		$criteria->compare('NM_JENIS_STANDAR2',$this->NM_JENIS_STANDAR2,true);
	 ...
	 * @return JenisStandar the static model class
	 */
	...
	public static function getStandar(){
		$sql = "SELECT * FROM tbjenis_standar";
		$command = YII::app()->db->createCommand($sql);
		return $command->queryAll();
	}		

	public static function getReportStandarDetail($standar){
		$sql = "SELECT
		nm_bidang AS bidang,
		no_nspm,
		judul1,
