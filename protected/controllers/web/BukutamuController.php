...
class BukutamuController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Bukutamu');
	...
	{
		$model=new Bukutamu('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bukutamu']))
			$model->attributes=$_GET['Bukutamu'];
	...
	{
		$model=Bukutamu::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Bukutamu $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bukutamu-form')
		{
