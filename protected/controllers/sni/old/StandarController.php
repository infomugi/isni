...
class StandarController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('create','update','view','delete','admin','index','changeimage','enable','disable','ajax','uploadisi','uploadringkasan'),
				'users'=>array('@'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Standar'];
			$model->TGL_SAVE = date('Y-m-d h:i:s');
	...
	{
		$dataProvider=new CActiveDataProvider('Standar');
	...
	{
		$model=Standar::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Standar $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='standar-form')
		{
