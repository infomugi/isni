...
$this->pageTitle='Standar Berdasarkan Bidang';
?>
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<section class="panel">
			<div class="panel-body">
				...
				<?php
				echo CHtml::beginForm(array('listbidang'));
				?>
	...
	<table id="example" width="100%" cellspacing="0" class="display">
		...
		<TBODY>
			...
			<?php foreach (Bidang::getReportBidangDetail($bidang) as $data) { ?> 
				<TR>
