								...
								<div class="modal-body">
									...
									<?php if(YII::app()->user->isGuest){ ?>
										...
										<?php }else{ ?>
											...
											<a class="btn btn-success btn-block"  href="<?php echo YII::app()->baseUrl; ?>/image/sni/ringkasan/<?php echo $file_isi; ?>" class="btn btn-warning btn-block"><i class="fa fa-download"></i> Download File Ringkasan</a>
											<?php } ?>
