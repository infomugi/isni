...
$data1 = SearchData::model()->get_count_SNI(01,$start,$end);
$data2 = SearchData::model()->get_count_SNI(02,$start,$end);
$data3 = SearchData::model()->get_count_SNI(03,$start,$end);
?>
...
<script type="text/javascript">
	...
	function drawChart1() {
		var data = google.visualization.arrayToDataTable([
			['Dokumen', 'SNI', 'Pedoman Teknis', 'Petunjuk Teknis'],
			['Dokumen', <?php echo $data1; ?>, <?php echo $data2; ?>, <?php echo $data3; ?>],
			]);

		var options = {
			title: 'Norma Standard Pedoman Manual',
			hAxis: {title: 'Jenis Standard', titleTextStyle: {color: 'red'}}
		};
